...
], ProductTag.prototype, "product_id", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.PrimaryColumn)(),
    __metadata("design:type", Number)
], ProductTag.prototype, "tag_id", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => tag_entity_1.Tag, (t) => t.id, {
        onDelete: 'CASCADE',
    }),
...
exports.ProductTag = ProductTag = __decorate([
    (0, typeorm_1.Entity)({ name: 'Product_Tags' })
], ProductTag);
