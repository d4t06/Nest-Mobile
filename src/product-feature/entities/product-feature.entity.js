...
__decorate([
    (0, typeorm_1.ManyToOne)(() => product_entity_1.Product, (p) => p.features, { onDelete: 'CASCADE' }),
...
], ProductFeature.prototype, "value", void 0);
exports.ProductFeature = ProductFeature = __decorate([
    (0, typeorm_1.Entity)({ name: 'Product_Features' })
], ProductFeature);
//# sourceMappingURL=product-feature.entity.js.map