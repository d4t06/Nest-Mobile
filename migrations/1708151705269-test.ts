...
export class Test1708151705269 implements MigrationInterface {
    name = 'Test1708151705269'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`Products\` ADD CONSTRAINT \`FK_686fd033da4d2d5954daab89290\` FOREIGN KEY (\`category_id\`) REFERENCES \`Categories\`(\`id\`) ON DELETE SET NULL ON UPDATE CASCADE`);
